				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input class="form-control" name="username" value="<?php echo $data_cek['username']; ?>" readonly/>
						</div>
...
if (isset($_POST['Ubah'])) {
	...
	$level = !empty($_POST['level']) ? $_POST['level'] : 'User';
	...
	// Update tabel tb_anggota jika nama diubah
	if ($query_ubah_pengguna) {
		$sql_ubah_anggota = "UPDATE tb_anggota SET
            nama='$nama_pengguna'
            WHERE id_pengguna='$id_pengguna'";
		mysqli_query($koneksi, $sql_ubah_anggota);
